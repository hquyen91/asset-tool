...
$hsql = "SELECT a.id, h.hw_name, c.cname, c.ctype, a.qty, a.doa, a.doe, u.username, v.vname, v.thumb
      	 FROM tbl_hardwares h, tbl_categories c, tbl_assignments a, assets u, tbl_vendors v
		 WHERE h.id = a.type AND h.cid = c.cid AND a.uid = u.userid AND h.vid = v.id AND a.entity = 1";
		
$ssql = "SELECT a.id, s.sw_name, c.cname, c.ctype, a.qty, a.doa, a.doe, u.username, v.vname, v.thumb
      	 FROM tbl_softwares s, tbl_categories c, tbl_assignments a, assets u, tbl_vendors v
		 WHERE s.id = a.type AND s.cid = c.cid AND a.uid = u.userid AND s.vid = v.id AND a.entity = 2";
